...
\item \textbf{The conclusion.} One independent lognormal-scale Brownian bridge does not fit the full cohort; the data motivate a boundary component plus continuous route regimes.
\end{itemize}
\par
\end{minipage}}
\endgroup
